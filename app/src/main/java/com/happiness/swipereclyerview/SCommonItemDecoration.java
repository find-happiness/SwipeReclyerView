...
public class SCommonItemDecoration extends RecyclerView.ItemDecoration {
  ...
  @Override public void getItemOffsets(Rect outRect, View view, RecyclerView parent,
    ...
    if (parent.getLayoutManager() instanceof GridLayoutManager) {
      ...
      spanCount =
          layoutManager.getSpanCount(); // Assume that there're spanCount items in this row/column.
    ...
    if (orientation == GridLayoutManager.VERTICAL) {
      ...
      if (props.getHasHorizontalEdge()) {
        ...
        bottom =
            props.getHorizontalSpace() * (spanCount - (spanIndex + spanSize - 1) - 1) / spanCount;
      }
  ...
  public static class ItemDecorationProps {
    ...
    public ItemDecorationProps(int horizontalSpace, int verticalSpace, boolean hasHorizontalEdge,
        boolean hasVerticalEdge) {
